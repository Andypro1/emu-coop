...
itemTable[0x1] = {desc = "the wood sword", game = 0, addr = 0x0657, kind = "add", toAdd = 1 };
...
itemTable[0x5] = {desc = "the recorder", game = 0, addr = 0x065c, value = 1, kind = "high" };
...
itemTable[0x40] = {desc = "a few rupees", game = 0, addr = 0x066d, kind = "add", toAdd = 5 };
itemTable[0x41] = {desc = "some rupees", game = 0, addr = 0x066d, kind = "add", toAdd = 10 };
itemTable[0x42] = {desc = "copious rupees", game = 0, addr = 0x066d, kind = "add", toAdd = 50 };
